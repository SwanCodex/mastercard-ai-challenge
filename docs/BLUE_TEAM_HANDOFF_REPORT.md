...
\*\*Report date:\*\* \[Day of writing — fill in]

\*\*Status:\*\* FINAL — both Version A (Layer 3 down) and Version B (Layer 3 live, via Groq) regression results included below
...
\## 9. Full Regression Test — Version B (Layer 3 Live, Groq)



\*\*Conditions:\*\* Same 68-event set as Version A, re-run with Layer 3 fully live. \*\*Note: switched Layer 3's provider from Gemini to Groq (`openai/gpt-oss-120b`) between Version A and B\*\*, after Gemini's free-tier daily quota (20 requests/day) proved too restrictive for iterative testing. Groq's free tier is far more generous and noticeably faster — this run completed in a couple of minutes versus the many minutes/hours Gemini calls were taking with retries.
